...
DSP3_theo = Ts3*sinc(freqcentered*Ts3).^2;
...
semilogy(freqcentered,DSP3); title("Comparaison DSP et DSP théorique");
xlabel("Fréquence (Hz)"); ylabel("DSP");
hold on;
semilogy(freqcentered,DSP3_theo); legend('DSP','DSP théo');
hold off;
